...
class Data extends AbstractHelper
{
    ...
    {
        return $this->isEnabled() && $this->getConfigValue(self::CONFIG_MODULE_PATH . '/' . self::CANONICAL_URL_CONFIGUARATION . '/enable_canonical_url', $storeId);
    }
    ...
    {
        return $this->getConfigValue(self::CONFIG_MODULE_PATH . '/' . self::CANONICAL_URL_CONFIGUARATION . '/disable_canonical_with_noindex_robots', $storeId);
    }
    ...
    {
        return array_map('trim', explode("\n", $this->getConfigValue(self::CONFIG_MODULE_PATH . '/' . self::CANONICAL_URL_CONFIGUARATION . '/disable_canonical_pages', $storeId)));
    }
}