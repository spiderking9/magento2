 ...
 */
namespace Blackbird\MenuManager\Controller\Adminhtml\ContentList\Widget;
...
class Chooser extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $block = $layout->createBlock(
            'Blackbird\MenuManager\Block\Adminhtml\ContentList\Widget\Chooser',
            'menu_nodetype_contentlist',
            ['data' => [
