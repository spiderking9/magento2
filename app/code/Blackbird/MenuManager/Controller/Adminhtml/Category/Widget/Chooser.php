 ...
 */
namespace Blackbird\MenuManager\Controller\Adminhtml\Category\Widget;
...
class Chooser extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $block = $layout->createBlock(
            'Blackbird\MenuManager\Block\Adminhtml\Category\Widget\Chooser',
            'menu_nodetype_category',
            ['data' => [
