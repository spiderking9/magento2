...
namespace Blackbird\MenuManager\Controller\Adminhtml\Product\Widget;
...
class Chooser extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $block = $layout->createBlock(
            'Blackbird\MenuManager\Block\Adminhtml\Catalog\Product\Widget\Chooser',
            'menu_nodetype_product',
            ['data' => [
