 ...
 */
namespace Blackbird\MenuManager\Block\Adminhtml\Content\Widget;
...
class Chooser extends \Blackbird\MenuManager\Block\Adminhtml\Widget\Chooser\AbstractChooser
{
    ...
    /**
     * @return \Blackbird\ContentManager\Model\ResourceModel\Content\CollectionFactory|mixed
     */
     ...
     */
    protected function getContentTypesSource()
    {
    ...
    public function prepareElementHtml(AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl(
            'menumanager/content_widget/chooser',
            ['uniq_id' => $uniqId]
        );
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'ct_id',
                'type' => 'options',
                'options' => $this->toOptions($this->getContentTypesSource()->toOptionArray()),
