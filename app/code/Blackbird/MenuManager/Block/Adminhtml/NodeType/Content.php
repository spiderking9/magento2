...
class Content extends Template implements NodeTypeInterfaceAdmin, NodeInterface
{
    /**
     * @var string
     */
    protected $_template = 'menu/nodetype/content.phtml';
    ...
    {
        return $this->getUrl('menumanager/content_widget/chooser/form/' . 'content_id');
    }
