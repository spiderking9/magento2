...
define([
    ...
    $.widget('mageplaza.layer', layer, {
        ...
        initInfiniteButton: function() {
            var self = this;

            $('#layer-product-list').on('click', this.options.loadProductsBtn, function(e) {
                e.stopPropagation();

                self.checkProductsToLoad();
            })
        },

        checkProductsToLoad: function() {
            var self = this,
                listEl = $('.items.product-items');
